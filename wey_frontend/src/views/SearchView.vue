        ...
        <div class="main-left col-span-3 space-y-4 ">
            <div class="bg-white border border-gray-200 rounded-lg">
                <div class="p-2 flex space-x-4">
                    <input type="search" class="p-4 w-full bg-grat-100 rounded-lg" placeholder="Arama Yapmak İçin Tıklayınız.">
                    <a href="#" class="inline-block py-4 px-6 bg-purple-600 text-white rounded-lg">ara</a>
                </div>
            </div>
            <div class="p-4 bg-white border border-gray-200 rounded-lg grid grid-cols-4 gap-4">
                <div class="p-4 bg-white border border-gray-200 text-center rounded-lg" v-for="i in 8" :key="i">
                    <img src="https://i.pravatar.cc/300?img=70" class="mb-6 rounded-full" alt="">
                    <p><strong>Muzaffer Nergiz</strong></p>
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                <div class="mb-6 flex items-center justify-between">
                    ...
                    <p class="text-gray-600">18 dakika önce</p>
                </div>
                <p class="text-2xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laudantium iure vero
                    inventore tempore
                    repellendus quod recusandae doloribus maiores est minus.</p>
                <div class="my-6 flex justify-between relative">
